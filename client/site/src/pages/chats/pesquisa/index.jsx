        ...
        <div className="pesquisa page ">
            ...
            <main>
                <ul className="pesquisa-categorias">
                    <nav
                        className={
                            selecionado === "usuarios" ? "selecionado" : ""
                        }
                        onClick={() => setSelecionado("usuarios")}
                    >
                        Usuários
                    </nav>
                    <nav
                        className={
                            selecionado === "comunidades" ? "selecionado" : ""
                        }
                        onClick={() => setSelecionado("comunidades")}
                    >
                        Comunidades
                    </nav>
                    <nav
                        className={
                            selecionado === "mensagens" ? "selecionado" : ""
                        }
                        onClick={() => setSelecionado("mensagens")}
                    >
                        Mensagens
                    </nav>
                </ul>
                ...
                <section>
                    {selecionado === "comunidades" &&
                        comunidades.map((item) => (
                            <Card
                                nome={item.nm_comunidade}
                                descricao={item.ds_comunidade}
                                imagem={item.img_comunidade}
                                id={item.id_comunidade}
                            />
                        ))}
